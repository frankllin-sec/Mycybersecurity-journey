...
<details>
  ...
  - **Linux Threat Detection 3** (Introduction, Reverse Shells, Privilege Escalation, Startup Persistence, Account Persistence, Targeted Attacks and Recap, Conclusion)
